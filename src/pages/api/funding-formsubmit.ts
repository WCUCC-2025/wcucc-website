...
export const POST: APIRoute = async context => {
    ...
    const pkg = f('package').charAt(0).toUpperCase() + f('package').slice(1);
    const cont = f('contributions');
    const contributions = cont || 'N/A';
    const email = f('email');
    const phone = f('phone');
    const message = f('sponsor-message');
    const isNearUBC = f('near-ubc') == 'yes' ? 'Yes' : 'No';
...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; font-size: 16px; line-height: 1.5; color: #333333; background-color: #f5f5f5;">
  ...
  <div style="display: none; max-height: 0px; overflow: hidden;">
    New sponsorship inquiry from ${fullName} - ${dispName}
  </div>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:rgb(255, 255, 255); color:rgb(0, 0, 0);">
          <tr>
            <td style="padding: 40px 20px 20px 20px; text-align: left;">
              ...
              <h1 style="margin: 0; font-size: 50px; font-weight: bold;">Sponsorship Inquiry</h1>
            </td>
          </tr>
        </table>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <td style="padding: 0 20px 30px 20px; font-size: 18px;">
              <p style="margin-top: 0; margin-bottom: 20px;">Sponsorship inquiry details:</p>
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                ...
                <tr>
                  ...
                  <td width="60%" style="padding: 10px; border-bottom: 1px solid #eeeeee;">${dispName}</td>
                </tr>
                <tr>
                  <td width="40%" style="padding: 10px; border-bottom: 1px solid #eeeeee; font-weight: bold;">Package Tier:</td>
                  <td width="60%" style="padding: 10px; border-bottom: 1px solid #eeeeee;">${pkg}</td>
                </tr>
                <tr>
                  <td width="40%" style="padding: 10px; border-bottom: 1px solid #eeeeee; font-weight: bold;">Contributions:</td>
                  <td width="60%" style="padding: 10px; border-bottom: 1px solid #eeeeee;">${contributions}</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td width="40%" style="padding: 10px; border-bottom: 1px solid #eeeeee; font-weight: bold;">Located near UBC:</td>
                  <td width="60%" style="padding: 10px; border-bottom: 1px solid #eeeeee;">${isNearUBC}</td>
                </tr>
              </table>
